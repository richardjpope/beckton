...
class Commitment(Form):
    ...
    rate = RadioField('What hours do you work?', [validators.Required(message="You need to enter what hours you work")], choices=_condition_terms)
